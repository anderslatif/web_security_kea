...
class ComponentChatElement extends Component {
    ...
    // }
    render() {
        const { handleChatState, handleChatStateSlide } = this.props;
        return (
            <div className="componentChatElement">
                <div className="chat__header">
                    <button>
                        <svg>
                            <use href="./image/sprite.svg#icon-maximize" />
                        </svg>
                    </button>
                    <h2>BookShelf Chat</h2>
                    <button onClick={handleChatStateSlide}>
                        <svg>
                            <use href="./image/sprite.svg#icon-cross" />
                        </svg>
                    </button>
                </div>
                ...
                <div className="chat__input">
                    <form className="chat__input--sendmessage">
                        <textarea onChange={this.setInput} />
